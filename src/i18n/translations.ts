...
export const translations = {
  cs: {
    ...
    proJednotlivce: {
      ...
      coachingFormatLabel: "Formát:",
      coachingBtn: "Zjistit více o koučinku",
      workshopsTag: "Workshopy",
      workshopsTitle: "Otevřené leadership workshopy",
      workshopsDesc: "Krátké, intenzivní tříhodinové workshopy pro jednotlivce v malé skupině. Zaměřené na praktické komunikační a leadership dovednosti, které mají okamžitý dopad na práci i vztahy.",
      workshopsList: ["Hluboké rozhovory", "Náročné rozhovory bez konfliktu", "Rozhodování lídra"],
      workshopsBtn: "Zobrazit workshopy",
    ...
    koucink: {
      ...
      pack12Title: "12× 90 minut",
      pack12Desc: "Coaching package",
      pack12Price: "54 000 Kč",
  ...
  en: {
    ...
    koucink: {
      ...
      package: "Package",
      pack6Title: "6× 90 minutes",
      pack6Desc: "Coaching package",
      pack6Price: "40 500 Kč",
      pack12Title: "12× 90 minutes",
      pack12Desc: "Coaching package",
      pack12Price: "67 500 Kč",
