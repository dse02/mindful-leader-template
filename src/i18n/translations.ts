...
export const translations = {
  cs: {
    ...
    proFirmy: {
      ...
      challenges: [
        "Obtížné rozhovory s\u00A0týmem nebo kolegy",
      ...
      challengesNote: "Tyto situace řešíme prakticky – skrze konkrétní rozhovory a\u00A0reálné situace z\u00A0vaší firmy.",
      cooperationTag: "Spolupráce",
      cooperationTitle: "Jak můžeme spolupracovat",
      cooperationBlocks: [
        { title: "Leadership workshopy", desc: "Praktické workshopy pro manažery a\u00A0týmy zaměřené na komunikaci, náročné rozhovory a\u00A0spolupráci." },
        { title: "Leadership koučink pro manažery", desc: "Individuální koučink pro lídry, kteří chtějí růst ve své roli a\u00A0zvládat náročné situace s\u00A0větší jistotou." },
        { title: "Programy na míru", desc: "Kombinace workshopů a\u00A0koučinku přizpůsobená konkrétním potřebám firmy." },
      ],
      coachingTag: "Koučink",
  ...
  en: {
    ...
    proFirmy: {
      ...
      challenges: [
        "Difficult conversations with team members or colleagues",
        "Conflicts between people or departments",
        "Lack of open communication",
        "Uncertainty in leading people",
        "Working in a multicultural environment",
      ],
      challengesNote: "We address these situations practically — through real conversations and actual scenarios from your company.",
      cooperationTag: "Collaboration",
      cooperationTitle: "How we can work together",
      cooperationBlocks: [
        { title: "Leadership workshops", desc: "Practical workshops for managers and teams focused on communication, difficult conversations, and collaboration." },
        { title: "Leadership coaching for managers", desc: "Individual coaching for leaders who want to grow in their role and handle challenging situations with greater confidence." },
        { title: "Tailored programs", desc: "A combination of workshops and coaching adapted to the specific needs of your company." },
      ],
